...
#TODO:# Skriv intro om UNIX, posix och open source
...
icon:book[] Läs: https://www.fosslinux.com/43292/linux-terminal-commands-to-try-for-a-beginner.htm[FOSS Linux, Top 20 Linux Terminal Commands to try for a Beginner]
...
== Filsystemet i Unix
icon:book[] Läs: https://tldp.org/LDP/sag/html/dir-tree-overview.html[kapitel 3 i The Linux System Administrator's Guide]
...
icon:book[] Läs: https://help.ubuntu.com/community/FilePermissions

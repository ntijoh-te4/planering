...
* Ibland kan man höra någon säga: _"produktägaren lägger sig inte i under sprinten"_. De är inte nödvändigtvis 100% sant men ambitionen är sann. Varför tror ni det är så upplägget är?

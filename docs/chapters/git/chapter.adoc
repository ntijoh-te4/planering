...
. Skapa issues för allt som ska ändras
. Assigna medlemmar till issues
. Skapa en branch för varje issue du jobbar med. Följ en naming convention i projektet.
. Skapa en pull request för din branch.
. Pull requests måste genomgå code review.

.Läs icon:book[]
* https://docs.github.com/en/issues/tracking-your-work-with-issues/quickstart[Quickstart for GitHub Issues]
* https://docs.github.com/en/get-started/quickstart/github-flow[GitHub flow]
* https://docs.github.com/en/issues/organizing-your-work-with-project-boards[Organizing your work with projects]
* https://deepsource.io/blog/git-branch-naming-conventions/[Git branch naming conventions]

...
* https://www.katacoda.com/sjnewhouse/scenarios/cli_bootcamp[Katacoda - Basic Linux and the Command Line], Övning: Alla från 16 ochbehöver ni, gör om 1-15 först.
